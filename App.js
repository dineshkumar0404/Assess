    ...
    return (
      <Formik
        ...
        validationSchema={Yup.object().shape({
          // add
          group3: Yup.string().required('Group3 is required'),
          group2: Yup.string().required('Group2 is required'),
          group1: Yup.string().required('Group1 is required'),
